...
uv add quarto numpy matplotlib openpyxl pandas great_tables pins plotly ipyleaflet pygwalker statsmodels session_info # Add the relevant packages
...
``` bash
cd Quarto/report-getting-started-python
